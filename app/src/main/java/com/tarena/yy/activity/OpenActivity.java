...
import static com.hyphenate.chat.core.EMDBManager.R;
...
public class OpenActivity extends Activity {
    ...
    private String _rtmpUrl = "rtmp://www.songjixiang.win:1935/hls/12345";
    ...
    private View.OnClickListener _switchCameraOnClickedEvent = new View.OnClickListener() {
        ...
        public void onClick(View arg0) {
            //华为i7前后共用摄像头
            if (Camera.getNumberOfCameras() == 1) {
                Toast.makeText(OpenActivity.this, "没有前置摄像头哦！",Toast.LENGTH_SHORT).show();
                return;
            }
...
//        _rtmpUrl = intent.getStringExtra(OpenActivity.RTMPURL_MESSAGE);
